...
import { StudentMaterialsPage } from './components/Student/StudentMaterialsPage';
...
const AppRoutes: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/materials" element={<ProtectedRoute><StudentMaterialsPage /></ProtectedRoute>} />
