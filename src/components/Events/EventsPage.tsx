    ...
    const mockEvents: Event[] = [
      {
        ...
        date: '2025-07-18',
        time: '02:00 PM',
        location: 'Brain Hub Learning Center',
        organizer: 'Brain Hub Team',
        attendees: 45,
        maxAttendees: 100,
        isRegistered: false,
      ...
      },
      {
        ...
        date: nextWeek.toISOString().split('T')[0],
        time: '02:00 PM',
        location: 'Brain Hub Center, Phuthaditjhaba',
        organizer: 'Brain Hub Administration',
        attendees: 112,
        maxAttendees: 150,
        isRegistered: false,
      ...
      },
      {
        ...
        time: '09:00 AM',
        location: 'Brain Hub Center, Harrismith',
        organizer: 'Brain Hub Career Services',
        attendees: 67,
        maxAttendees: 120,
        isRegistered: false,
      ...
      },
      {
        ...
        organizer: 'Brain Hub Student Council',
        attendees: 178,
        maxAttendees: 250,
        isRegistered: false,
            ...
            >
              ...
              <div className="p-6">
                ...
                <button
                  ...
                  className={`w-full py-2 px-4 rounded-lg font-medium transition-colors ${event.isRegistered
